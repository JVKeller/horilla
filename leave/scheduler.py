...
def leave_reset():
    ...
    try:
        for leave_type in leave_types:
            ...
            for available_leave in available_leaves:
                ...
                if expired_date and expired_date <= today_date:
                    new_expired_date = available_leave.leave_type_id.set_expired_date(
                        available_leave=available_leave, 
                        assigned_date=today_date
                    )
            ...
            # Handle leave type expiry
            if (leave_type.carryforward_expire_date and 
                leave_type.carryforward_expire_date <= today_date):
        ...
        print(f"Error in leave_reset: {str(e)}")
